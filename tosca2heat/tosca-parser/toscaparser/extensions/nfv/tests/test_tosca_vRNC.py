...
class ToscaVRNCTemplateTest(TestCase):
    ...
    def test_nodetemplates(self):
        ...
        ["EXTERMEDIA_Net","DM", "CM_Port_CTRL","LB_Port_INTERMEDIA",
	     "MM_BlockStorage","MM_Port_EXTERMEDIA","MM_Active",
	     "INTERMEDIA_Net","CM_Passive","CM_Port_INTERMEDIA",
	     "LB","DM_Port_INTERMEDIA","LB_Port_EXTERMEDIA",
	     "CM_Active","MM_Port_EMS","MM_Port_CTRL","MM_Passive",
	     "LB_Port_CTRL","CTRL_Net","EMS_Net","DM_Port_CTRL"])

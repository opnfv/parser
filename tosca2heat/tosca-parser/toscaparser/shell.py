...
class ParserShell(object):
    ...
    def output(self, tosca_object, pretty_print=False):
        ...
        if output2file:
            ...
            json.dump(tosca_object, fp, skipkeys=False, indent=indent, default=object2dict, separators=separators, sort_keys=True)
            return
        return json.dumps(tosca_object, skipkeys=True, indent=indent, default=object2dict, separators=separators, sort_keys=True)

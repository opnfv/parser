...
Architecture
------------
VeriGraph exploits two sub-modules: **Z3**, the SMT solver developed by Microsoft, and **Neo4JManger**,
a module that can store service graphs into a *Neo4J* graph-oriented database, and extract from them
all the VNF chains that are relevant for checking their reachability properties.
